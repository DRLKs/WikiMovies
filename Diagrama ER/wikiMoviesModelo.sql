...
CREATE TABLE IF NOT EXISTS `Peliculas_TMDb`.`Crew_Personaje` (
  ...
  INDEX `fk_Crew_has_Personaje_Crew1_idx` (`Crew_id_crew` ASC) VISIBLE,
  CONSTRAINT `fk_Crew_has_Personaje_Crew1`
    FOREIGN KEY (`Crew_id_crew`)
    REFERENCES `Peliculas_TMDb`.`Crew` (`id_crew`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `Peliculas_TMDb`.`Crew_Trabajo` (
  ...
  INDEX `fk_Crew_has_Trabajo_Crew1_idx` (`Crew_id_crew` ASC) VISIBLE,

    ...
    <div class="profile">
        <div class="profile">
            ...
            <% if (usuario != null) { %>
                ...
                <a href="profile?id=<%= usuario.getIdUsuario() %>" >
                    <img class="profile-image" src="<%= (usuario.getAvatar() != null) ? usuario.getAvatar() : "../../img/default-avatar.png" %>" alt="Avatar de <%= usuario.getNombreUsuario() %>">
                </a>
